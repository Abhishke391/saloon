    ...
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4">
            ...
            <div  className="flex-1 flex flex-col gap-1">
              ...
              <select onChange={(e)=> setExperience(e.target.value)} value={experience} name="" id="">
                <option className="border rounded px-3 py-2" value="1 Year">1 Year</option>
        ...
        <div>
          ...
          <textarea onChange={(e)=> setAbout(e.target.value)} value={about} className="w-full pt-2 border rounded" placeholder="Write about doctor" rows={5} required />
        </div>
